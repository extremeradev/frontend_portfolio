    ...
    <section class="text-white mt-18" id="about">
        ...
        <div class="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 z-1">
            <div data-aos="flip-right">
                <h2 class="text-4xl font-bold text-white text-left mb-8">Educación</h2>
            ...
            <div class="mt-4 md:mt-0 text-left flex flex-col z-10 h-full" data-aos="flip-right">
                <h2 class="text-4xl font-bold text-white md:text-center text-left mb-4">Sobre
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">mi</span>
                    
                </h2>
                <p class="text-base lg:text-lg mt-8 py-8"> 
                    Me apasiona la programación porque me permite resolver problemas complejos 
                    de manera creativa y mejorar la vida de los usuarios. Siempre busco aprender 
                    nuevas tecnologías y enfoques para seguir creciendo como profesional.
                </p>
            </div>
        </div>
    </section>
